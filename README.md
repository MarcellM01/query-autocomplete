...
- See [THIRD_PARTY_LICENSES.md](./python-package/THIRD_PARTY_LICENSES.md) for a short note and links to upstream metadata.
...
```bash
python -m pip install -e ./python-package[dev]
```
